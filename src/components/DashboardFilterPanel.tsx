...
export function DashboardFilterPanel({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm z-[70] md:relative md:bg-transparent md:backdrop-blur-none md:z-auto">
      <div className="fixed right-0 top-0 h-full w-full max-w-xs bg-white dark:bg-gray-800 shadow-lg p-6 overflow-y-auto md:relative md:max-w-none md:h-auto md:shadow-none md:p-0">
