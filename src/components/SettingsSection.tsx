...
export function SettingsSection({
  ...
  return (
    <section>
      <h2 className="text-2xl font-semibold flex items-center gap-2 mb-4 text-gray-100"><Settings size={28} aria-hidden="true" /> Configuraciones</h2>
      <div className="space-y-6 max-w-md">
        <div>
          <label htmlFor="scanError" className="block font-semibold mb-2 text-gray-100">Probabilidad de error al escanear (%)</label>
          <input
            id="scanError"
            type="number"
            min={0}
          ...
          />
          <small id="scanErrorHelp" className="text-gray-400">
            Ajusta la probabilidad de que el escaneo falle para probar la búsqueda manual.
          </small>
        </div>
        <div>
          <label htmlFor="defaultMaxStock" className="block font-semibold mb-2 text-gray-100">Capacidad Máxima de Stock por Defecto</label>
          <input
            id="defaultMaxStock"
            type="number"
            min={1}
          ...
          />
          <small id="defaultMaxStockHelp" className="text-gray-400">
